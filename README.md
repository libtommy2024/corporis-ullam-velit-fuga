<h1><img src="https://@libtommy2024/corporis-ullam-velit-fuga.org/img/@libtommy2024/corporis-ullam-velit-fuga-banner-logo.png" alt="Terser" width="400"></h1>
...
*note*: <s>You can support this project on patreon: [link]</s> **The Terser Patreon is shutting down in favor of opencollective**. Check out [PATRONS.md](https://github.com/libtommy2024/corporis-ullam-velit-fuga/blob/master/PATRONS.md) for our first-tier patrons.

Terser recommends you use RollupJS to bundle your modules, as that produces smaller code overall.

*Beautification* has been undocumented and is *being removed* from @libtommy2024/corporis-ullam-velit-fuga, we recommend you use [prettier](https://npmjs.com/package/prettier).

Find the changelog in [CHANGELOG.md](https://github.com/libtommy2024/corporis-ullam-velit-fuga/blob/master/CHANGELOG.md)



[npm-image]: https://img.shields.io/npm/v/@libtommy2024/corporis-ullam-velit-fuga.svg
[npm-url]: https://npmjs.org/package/@libtommy2024/corporis-ullam-velit-fuga
[downloads-image]: https://img.shields.io/npm/dm/@libtommy2024/corporis-ullam-velit-fuga.svg
[downloads-url]: https://npmjs.org/package/@libtommy2024/corporis-ullam-velit-fuga
[ci-image]: https://github.com/libtommy2024/corporis-ullam-velit-fuga/actions/workflows/ci.yml/badge.svg
[ci-url]: https://github.com/libtommy2024/corporis-ullam-velit-fuga/actions/workflows/ci.yml
[opencollective-contributors]: https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/tiers/badge.svg
[opencollective-url]: https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga

Why choose @libtommy2024/corporis-ullam-velit-fuga?
------------------
...
**`@libtommy2024/corporis-ullam-velit-fuga`** is a fork of `uglify-es` that mostly retains API and CLI compatibility
...
From NPM for use as a command line app:
    ...
    npm install @libtommy2024/corporis-ullam-velit-fuga -g

From NPM for programmatic use:

    npm install @libtommy2024/corporis-ullam-velit-fuga
...
```
@libtommy2024/corporis-ullam-velit-fuga [input files] [options]
```
...
instance:
    ...
    @libtommy2024/corporis-ullam-velit-fuga input.js --compress ecma=2015,computed_props=false
...
a double dash to prevent input files being used as option arguments:
    ...
    @libtommy2024/corporis-ullam-velit-fuga --compress --mangle -- input.js
...
```
    ...
    --safari10                  Support non-standard Safari 10/11.
                                ...
                                By default `@libtommy2024/corporis-ullam-velit-fuga` will not work around
                                Safari 10/11 bugs.
...
For example:
    ...
    @libtommy2024/corporis-ullam-velit-fuga js/file1.js js/file2.js \
             -o foo.min.js -c -m \
...
Example:
    ...
    @libtommy2024/corporis-ullam-velit-fuga file.js -c toplevel,sequences=false
...
comma-separated list of names.  For example:
    ...
    @libtommy2024/corporis-ullam-velit-fuga ... -m reserved=['$','require','exports']
...
```
@libtommy2024/corporis-ullam-velit-fuga example.js -c -m --mangle-props regex=/_$/
```
...
```bash
$ @libtommy2024/corporis-ullam-velit-fuga example.js -c passes=2 -m --mangle-props
```
```javascript
...
```bash
$ @libtommy2024/corporis-ullam-velit-fuga example.js -c passes=2 -m --mangle-props reserved=[foo_,bar_]
```
```javascript
...
```bash
$ @libtommy2024/corporis-ullam-velit-fuga example.js -c passes=2 -m --mangle-props regex=/_$/
```
```javascript
...
```bash
$ @libtommy2024/corporis-ullam-velit-fuga example.js -c passes=2 -m --mangle-props regex=/_$/,reserved=[bar_]
```
```javascript
...
$ @libtommy2024/corporis-ullam-velit-fuga file1.js file2.js --mangle-props --name-cache /tmp/cache.json -o part1.js
$ @libtommy2024/corporis-ullam-velit-fuga file3.js file4.js --mangle-props --name-cache /tmp/cache.json -o part2.js
```
...
```
```bash
$ @libtommy2024/corporis-ullam-velit-fuga stuff.js --mangle-props keep_quoted -c -m
```
```javascript
...
```bash
$ @libtommy2024/corporis-ullam-velit-fuga stuff.js --mangle-props debug -c -m
```
```javascript
...
```javascript
const { minify } = require("@libtommy2024/corporis-ullam-velit-fuga");
```

Or,

```javascript
import { minify } from "@libtommy2024/corporis-ullam-velit-fuga";
```
...
<script src="https://cdn.jsdelivr.net/npm/@libtommy2024/corporis-ullam-velit-fuga/dist/bundle.min.js"></script>
```
...
- `undeclared` (default: `false`) - Mangle those names when they are accessed
  ...
  See [#397](https://github.com/libtommy2024/corporis-ullam-velit-fuga/issues/397) for more details.
...
and build your code like this:
    ...
    @libtommy2024/corporis-ullam-velit-fuga build/defines.js js/foo.js js/bar.js... -c
...
compress that:
    ...
    acorn file.js | @libtommy2024/corporis-ullam-velit-fuga -p spidermonkey -m -c
...
| @libtommy2024/corporis-ullam-velit-fuga@3.7.5 mangle=false, compress=false   | 316,600 |  85,245 |  0.82 |
| @libtommy2024/corporis-ullam-velit-fuga@3.7.5 mangle=true, compress=false    | 220,216 |  72,730 |  1.45 |
| @libtommy2024/corporis-ullam-velit-fuga@3.7.5 mangle=true, compress=true     | 212,046 |  70,954 |  5.87 |
...
```
@libtommy2024/corporis-ullam-velit-fuga file.js -m
```
...
Without this, all variable values will be `undefined`. See https://github.com/libtommy2024/corporis-ullam-velit-fuga/issues/1367 for more details.
<br/><br/>
...
https://www.npmjs.com/browse/depended/@libtommy2024/corporis-ullam-velit-fuga

### Replacing `uglify-es` with `@libtommy2024/corporis-ullam-velit-fuga` in a project using `yarn`

A number of JS bundlers and uglify wrappers are still using buggy versions
of `uglify-es` and have not yet upgraded to `@libtommy2024/corporis-ullam-velit-fuga`. If you are using `yarn`
you can add the following alias to your project's `package.json` file:

```js
  "resolutions": {
    "uglify-es": "npm:@libtommy2024/corporis-ullam-velit-fuga"
  }
```

to use `@libtommy2024/corporis-ullam-velit-fuga` instead of `uglify-es` in all deeply nested dependencies
...
Because users often don't control the call to `await minify()` or its arguments, Terser provides a `TERSER_DEBUG_DIR` environment variable to make @libtommy2024/corporis-ullam-velit-fuga output some debug logs.

These logs will contain the input code and options of each `minify()` call.

```bash
TERSER_DEBUG_DIR=/tmp/@libtommy2024/corporis-ullam-velit-fuga-log-dir command-that-uses-@libtommy2024/corporis-ullam-velit-fuga
ls /tmp/@libtommy2024/corporis-ullam-velit-fuga-log-dir
@libtommy2024/corporis-ullam-velit-fuga-debug-123456.log
```
...
```
> npx cross-env TERSER_DEBUG_DIR=/path/to/logs command-that-uses-@libtommy2024/corporis-ullam-velit-fuga
```

## Stack traces

In the @libtommy2024/corporis-ullam-velit-fuga CLI we use [source-map-support](https://npmjs.com/source-map-support) to produce good error stacks. In your own app, you're expected to enable source-map-support (read their docs) to have nice stack traces that will help you write good issues.
...
<a href="https://github.com/libtommy2024/corporis-ullam-velit-fuga/graphs/contributors"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/contributors.svg?width=890&button=false" /></a>

### Financial Contributors

Become a financial contributor and help us sustain our community. [[Contribute](https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/contribute)]

#### Individuals

<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/individuals.svg?width=890"></a>

#### Organizations

Support this project with your organization. Your logo will show up here with a link to your website. [[Contribute](https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/contribute)]

<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/0/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/0/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/1/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/1/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/2/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/2/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/3/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/3/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/4/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/4/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/5/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/5/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/6/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/6/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/7/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/7/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/8/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/8/avatar.svg"></a>
<a href="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/9/website"><img src="https://opencollective.com/@libtommy2024/corporis-ullam-velit-fuga/organization/9/avatar.svg"></a>
